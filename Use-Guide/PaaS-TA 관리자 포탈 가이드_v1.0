...
> ![](./media/portal-web-admin-24.png)

1.  관리버튼를 눌러 비밀번호 초기화를 선택해 비밀번호를 초기화 한다.

> ![](./media/portal-web-admin-25.png)
>
> ![](./media/portal-web-admin-26.png)

1.  관리버튼를 눌러 운영권한 부여를 선택해 관리자 권한을 부여한다.

> ![](./media/portal-web-admin-27.png)
>
> ![](./media/portal-web-admin-28.png)

1.  관리버튼를 눌러 계정 삭제를 선택해 해당 계정을 삭제한다.

> ![](./media/portal-web-admin-29.png)
>
> ![](./media/portal-web-admin-30.png)
...
>
> ![](./media/portal-web-admin-31.png)

1.  WEB IDE 신청 유저의 URL과 사용유무를 지정한 후 저장버튼을 눌러
    수정해준다.

> ![](./media/portal-web-admin-32.png)

1.  WEB IDE 신청 유저리스트에서 삭제할 회원은 삭제버튼을 눌러 삭제한다.

> ![](./media/portal-web-admin-33.png)
...
> 검색창에서 검색유형, 검색항목, 공개여부, 검색어로 검색이 가능하다.
>
> ![](./media/portal-web-admin-46.png)

1.  서비스 이름을 클릭하면 상세화면이 나온다. 수정할 내역이 있을 경우
    수정 한 후 저장버튼을 누르면 저장된다.

> ![](./media/portal-web-admin-47.png)

1.  서비스를 삭제하기 위해 왼쪽 하단의 삭제버튼을 누른다.

> ![](./media/portal-web-admin-48.png)
...
> 검색창에서 게시일, 검색항목, 공개여부, 검색어로 검색이 가능하다.
>
> ![](./media/portal-web-admin-55.png)

1.  게시물을 클릭하면 상세화면이 나온다. 제목, 작성자, 내용, 첨부파일,
    댓글을 볼 수 있다.

> ![](./media/portal-web-admin-56.png)

1.  게시물을 삭제하려면 상세화면의 왼쪽 하단의 삭제버튼을 누르면
    삭제된다.

> ![](./media/portal-web-admin-57.png)
