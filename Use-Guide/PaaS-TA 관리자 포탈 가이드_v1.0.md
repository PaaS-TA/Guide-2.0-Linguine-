...
> ![](./image/admin-portal/portal-web-admin-01.png)

1.  아이디와 비밀번호를 입력후 LOGIN 버튼을 클릭한다.

> ![](./image/admin-portal/portal-web-admin-02.png)

### <a name="2.2"/>  2.2. PaaSTA관리자 포탈 로그아웃

1.  로그인 상태에서 메인화면 우측 상단의 로그아웃 버튼을 클릭한다.

> ![](./image/admin-portal/portal-web-admin-03.png)
...
> ![](./image/admin-portal/portal-web-admin-04.png)

1.  조직을 클릭하면 조직의 영역 상세 정보를 확인 할 수 있다.

> ![](./image/admin-portal/portal-web-admin-05.png)
...
> ![](./image/admin-portal/portal-web-admin-06.png)

1.  PaaSTA 포탈에서 사용하는 설정 정보들을 수정하고 저장한다.

> ![](./image/admin-portal/portal-web-admin-07.png)
...
> ![](./image/admin-portal/portal-web-admin-08.png)

1.  코드 그룹의 코드 ID를 더블클릭하면 상세 코드 정보가 조회된다.

> ![](./image/admin-portal/portal-web-admin-09.png)

1.  코드 그룹을 추가하기 위해 추가버튼을 누른 후 코드ID와 코드이름을
    입력하고 저장버튼을 누른다.

> ![](./image/admin-portal/portal-web-admin-10.png)

1.  코드를 추가하기 위해 추가버튼을 누른 후 Key, Value, 요약를 입력하고
    저장버튼을 누른다.

> ![](./image/admin-portal/portal-web-admin-11.png)

1.  코드를 삭제하기 삭제할 아이템을 체크하고 삭제버튼을 누른다.

> ![](./image/admin-portal/portal-web-admin-12.png)

### <a name="4.3"/>  4.3. 조직 및 공간 조회

1.  조직과 공간을 조회한다. 검색어로 조회도 가능하다.

> ![](./image/admin-portal/portal-web-admin-13.png)

1.  조직이름 옆의 상세정보 버튼을 눌러서 조직 정보를 상세 조회한다.

> ![](./image/admin-portal/portal-web-admin-14.png)

1.  공간이름 옆의 상세정보 버튼을 눌러서 공간 정보를 상세조회한다.

> ![](./image/admin-portal/portal-web-admin-15.png)

### <a name="4.4"/>  4.4. 조직 및 공간 조회클라이언트

1.  클라이언트 목록을 조회한다.

> ![](./image/admin-portal/portal-web-admin-16.png)

1.  클라이언트 ID를 클릭하면 상세화면을 이동한다.

> ![](./image/admin-portal/portal-web-admin-17.png)

1.  아이디, 패스워드, 옵션, 옵션 가이드를 입력하고 등록버튼을 눌러
    등록한다.

> ![](./image/admin-portal/portal-web-admin-18.png)

### <a name="4.5"/>  4.5. 권한 관리

1.  권한 그룹과 사용자를 조회한다.

> ![](./image/admin-portal/portal-web-admin-19.png)

1.  그룹 생성 버튼을 클릭하여 권한그룹을 생성한다.

> ![](./image/admin-portal/portal-web-admin-20.png)

1.  그룹 삭제 버튼을 클릭하여 권한그룹을 삭제한다.

> ![](./image/admin-portal/portal-web-admin-21.png)

1.  유저 등록 버튼을 클릭하여 유저를 등록한다.

> ![](./image/admin-portal/portal-web-admin-22.png)

1.  유저 삭제 버튼을 클릭하여 유저를 삭제한다.

> ![](./image/admin-portal/portal-web-admin-23.png)
...
> ![](./image/admin-portal/portal-web-admin-24.png)

1.  관리버튼를 눌러 비밀번호 초기화를 선택해 비밀번호를 초기화 한다.

> ![](./image/admin-portal/portal-web-admin-25.png)
>
> ![](./image/admin-portal/portal-web-admin-26.png)

1.  관리버튼를 눌러 운영권한 부여를 선택해 관리자 권한을 부여한다.

> ![](./image/admin-portal/portal-web-admin-27.png)
>
> ![](./image/admin-portal/portal-web-admin-28.png)

1.  관리버튼를 눌러 계정 삭제를 선택해 해당 계정을 삭제한다.

> ![](./image/admin-portal/portal-web-admin-29.png)
>
> ![](./image/admin-portal/portal-web-admin-30.png)
...
>
> ![](./image/admin-portal/portal-web-admin-31.png)

1.  WEB IDE 신청 유저의 URL과 사용유무를 지정한 후 저장버튼을 눌러
    수정해준다.

> ![](./image/admin-portal/portal-web-admin-32.png)

1.  WEB IDE 신청 유저리스트에서 삭제할 회원은 삭제버튼을 눌러 삭제한다.

> ![](./image/admin-portal/portal-web-admin-33.png)
...
>
> ![](./image/admin-portal/portal-web-admin-34.png)
...
> ![](./image/admin-portal/portal-web-admin-35.png)

1.  PaaSTA 사용자 포탈의 상단 메뉴를 생성하기 위해 메뉴 추가 버튼을
    누르고 메뉴 이름, 메뉴URL, 배치순서, 로그인여부, 사용여부를 입력하고
    저장한다.

> ![](./image/admin-portal/portal-web-admin-36.png)

1.  메뉴를 삭제하기 위해 오른쪽 하단의 삭제 버튼을 누르고 삭제한다.

> ![](./image/admin-portal/portal-web-admin-37.png)
...
>
> ![](./image/admin-portal/portal-web-admin-38.png)

1.  앱 템플릿 이름을 클릭하면 상세화면이 나온다. 수정할 내역이 있을 경우
    수정 한 후 저장버튼을 누르면 저장된다.

> ![](./image/admin-portal/portal-web-admin-39.png)

1.  앱템플릿을 삭제하기 위해 왼쪽 하단의 삭제버튼을 누른다.

> ![](./image/admin-portal/portal-web-admin-40.png)
...
>
> ![](./image/admin-portal/portal-web-admin-41.png)
...
> 검색창에서 검색유형, 검색항목, 공개여부, 검색어로 검색이 가능하다.
>
> ![](./image/admin-portal/portal-web-admin-42.png)

1.  앱 개발환경 이름을 클릭하면 상세화면이 나온다. 수정할 내역이 있을
    경우 수정 한 후 저장버튼을 누르면 저장된다.

> ![](./image/admin-portal/portal-web-admin-43.png)

1.  앱 개발환경을 삭제하기 위해 왼쪽 하단의 삭제버튼을 누른다.

> ![](./image/admin-portal/portal-web-admin-44.png)
...
>
> ![](./image/admin-portal/portal-web-admin-45.png)
...
> 검색창에서 검색유형, 검색항목, 공개여부, 검색어로 검색이 가능하다.
>
> ![](./image/admin-portal/portal-web-admin-46.png)

1.  서비스 이름을 클릭하면 상세화면이 나온다. 수정할 내역이 있을 경우
    수정 한 후 저장버튼을 누르면 저장된다.

> ![](./image/admin-portal/portal-web-admin-47.png)

1.  서비스를 삭제하기 위해 왼쪽 하단의 삭제버튼을 누른다.

> ![](./image/admin-portal/portal-web-admin-48.png)
...
>
> ![](./image/admin-portal/portal-web-admin-49.png)
...
>
> ![](./image/admin-portal/portal-web-admin-53.png)

1.  게시물을 클릭하면 문의 상세화면이 나온다. 답변할 내역이 있을 경우
    수정 한 후 둥록버튼을 누르면 수정된다.

> ![](./image/admin-portal/portal-web-admin-54.png)
...
> 검색창에서 게시일, 검색항목, 공개여부, 검색어로 검색이 가능하다.
>
> ![](./image/admin-portal/portal-web-admin-55.png)

1.  게시물을 클릭하면 상세화면이 나온다. 제목, 작성자, 내용, 첨부파일,
    댓글을 볼 수 있다.

> ![](./image/admin-portal/portal-web-admin-56.png)

1.  게시물을 삭제하려면 상세화면의 왼쪽 하단의 삭제버튼을 누르면
    삭제된다.

> ![](./image/admin-portal/portal-web-admin-57.png)
...
> 검색창에서 게시일, 검색항목, 공개여부, 검색어로 검색이 가능하다.
>
> ![](./image/admin-portal/portal-web-admin-58.png)

1.  게시물을 클릭하면 상세화면이 나온다. 제목, 작성자, 내용, 첨부파일,
    댓글을 볼 수 있다. 수정할 내역이 있을 경우 수정 한 후 저장버튼을
    누르면 수정된다.

> ![](./image/admin-portal/portal-web-admin-59.png)

1.  게시물을 삭제하려면 상세화면의 왼쪽 하단의 삭제버튼을 누르면
    삭제된다.

> ![](./image/admin-portal/portal-web-admin-60.png)

1.  문서 게시판 리스트 화면에서 문서를 등록하기 위해 문서등록버튼을
    누르면 다음의 화면이 나온다. 제목, 분류, 공개여부, 내용, 첨부파일을
    입력하고 등록버튼을 누르면 새로운 서비스가 등록된다.

> ![](./image/admin-portal/portal-web-admin-61.png)
